  ...
  return (
    <footer>
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        ...
        {/* Top area: Blocks */}
        <div className="hidden gap-8 py-8 border-t border-gray-200 sm:grid-cols-12 md:py-12">
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="w-full px-3 py-2 pr-12 text-sm text-gray-800 form-input" placeholder="Your email" required />
        ...
        <div className="py-4 border-t border-gray-200 md:flex md:items-center md:justify-between md:py-8">
          ...
          {/* Copyrights note */}
          <div className="mr-4 text-sm text-gray-600">Feito por <a className="text-blue-600 hover:underline" href="https://cruip.com/">Zedaká</a>. Todos os direitos reservados.</div>
